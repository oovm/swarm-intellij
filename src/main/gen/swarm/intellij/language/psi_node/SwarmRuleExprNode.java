...
public class SwarmRuleExprNode extends ASTWrapperPsiElement implements SwarmRuleExpr {

  public SwarmRuleExprNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SwarmRuleTerm> getRuleTermList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SwarmRuleTerm.class);
  }
