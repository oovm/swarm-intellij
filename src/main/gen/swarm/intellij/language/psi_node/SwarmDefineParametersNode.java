...
public class SwarmDefineParametersNode extends ASTWrapperPsiElement implements SwarmDefineParameters {

  public SwarmDefineParametersNode(@NotNull ASTNode node) {
    super(node);
  }
