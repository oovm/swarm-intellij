...
public class SwarmExportStatementNode extends ASTWrapperPsiElement implements SwarmExportStatement {

  public SwarmExportStatementNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SwarmObject getObject() {
    return findChildByClass(SwarmObject.class);
  }
