...
public class SwarmKeyNode extends ASTWrapperPsiElement implements SwarmKey {

  public SwarmKeyNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SwarmKeySymbol getKeySymbol() {
    return findChildByClass(SwarmKeySymbol.class);
  }
