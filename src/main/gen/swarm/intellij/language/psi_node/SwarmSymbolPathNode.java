...
public class SwarmSymbolPathNode extends ASTWrapperPsiElement implements SwarmSymbolPath {

  public SwarmSymbolPathNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SwarmKey> getKeyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SwarmKey.class);
  }
