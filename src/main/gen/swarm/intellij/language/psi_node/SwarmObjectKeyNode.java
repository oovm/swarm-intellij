...
public class SwarmObjectKeyNode extends ASTWrapperPsiElement implements SwarmObjectKey {

  public SwarmObjectKeyNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SwarmIdentifier getIdentifier() {
    return findChildByClass(SwarmIdentifier.class);
  }
