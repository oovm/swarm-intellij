...
import swarm.intellij.language.file.SwarmBundle.messagePointer as keyof
...
enum class HighlightColor(
    ...
    val textAttributesKey: TextAttributesKey = TextAttributesKey.createTextAttributesKey("swarm.$name", default)
