...
class LanguageCodeStyleSettingsProvider : LanguageCodeStyleSettingsProvider() {
    override fun getLanguage() = SwarmLanguage
    ...
    override fun getCodeSample(settingsType: SettingsType) = javaClass.getResource("/fileTemplates/codeStyle.swarm")!!.readText()
